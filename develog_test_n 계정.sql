...
--카테고리 샘플
INSERT INTO CATEGORY VALUES(SEQ_CATEGORY.NEXTVAL, '샘플', 3);
-- 포스트 샘플 데이터 생성
INSERT INTO POST VALUES(SEQ_POST.NEXTVAL, '안녕하세요', '이건 <br> 내용', DEFAULT, DEFAULT, DEFAULT, DEFAULT,DEFAULT, 3, 1 ,500); 
...
INSERT INTO TAG
VALUES (SEQ_TAG.NEXTVAL, '샘플태그');


ALTER TABLE TAG ADD POST_NO NUMBER NOT NULL;
...
VALUES(SEQ_MEMBER_SNS.NEXTVAL, 3, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT );
