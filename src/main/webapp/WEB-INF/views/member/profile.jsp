	        ...
	        <div class="content" style="padding: 35px;">
	          ...
	          <div class="sns-email" >
	            ...
	            <div class="email-input">
	                <input type="text"  class="line-intro" id="emailContent" name="snsEmail" value="${profileVO.snsEmail}"  placeholder="이메일을 입력해주세요." maxlength = 25 >
	            </div>
	          </div>
	          ...
	          <div class="sns-github" >
	            ...
	            <div class="github-input">
	                <input type="text"  class="line-intro" id="gitContent" name="snsGit" value="${profileVO.snsGit}"  placeholder="Github 계정을 입력하세요." maxlength = 25 >
	            </div>
	          </div>
	          ...
	          <div class="sns-homepage">
	            ...
	            <div class="homepage-input">
	                <input type="text" class="line-intro" id="homeContent" name="snsHome" value="${profileVO.snsHome}" placeholder="홈페이지 주소를 입력하세요." maxlength = 25 >
	            </div>
	          </div> <!-- homepage -->
